...
class PromptDeSelecao(View):
    ...
    def __init__(
        ...
        super().__init__()
        self.children[0].placeholder, self.children[0].max_values, self.children[0].options = Res.trad_nada( str=placeholder_str), max_values, options 
        self.values = None
        self.ephemeral = ephemeral
...
class PromptDeSelecaoDeCanal(View):
    ...
    def __init__(
        ...
        self.values = None
        self.ephemeral = ephemeral
        self.children[0].placeholder, self.children[0].max_values = Res.trad_nada( str=placeholder_str), max_values
...
class CriadorDeEmbed(View):
    ...
    def __init__( self, *, interacao: Union[Interaction, Context], embed: Optional[Embed] = None, timeout: Optional[float] = None, **kwargs: Any, ) -> None:
        ...
        self.options_data = [
            {
                "label": kwargs.get("author_label", Res.trad_nada( str="author_label")),
                "description": kwargs.get("author_description", Res.trad_nada( str="author_description")),
                "emoji": kwargs.get("author_emoji", "✨"),
                "value": "author",
            },
            {
                "label": kwargs.get("message_label", Res.trad_nada( str="message_label")),
                "description": kwargs.get("message_description", Res.trad_nada( str="message_description")),
                "emoji": kwargs.get("message_emoji", "📝"),
                "value": "message",
            },
            {
                "label": kwargs.get("thumbnail_label", Res.trad_nada( str="thumbnail_label")),
                "description": kwargs.get("thumbnail_description", Res.trad_nada( str="thumbnail_description")),
                "emoji": kwargs.get("thumbnail_emoji", "🖼️"),
                "value": "thumbnail",
            },
            {
                "label": kwargs.get("image_label", Res.trad_nada( str="image_label")),
                "description": kwargs.get("image_description", Res.trad_nada( str="image_description")),
                "emoji": kwargs.get("image_emoji", "📸"),
                "value": "image",
            },
            {
                "label": kwargs.get("footer_label", Res.trad_nada( str="footer_label")),
                "description": kwargs.get("footer_description", Res.trad_nada( str="footer_description")),
                "emoji": kwargs.get("footer_emoji", "📜"),
                "value": "footer",
            },
            {
                "label": kwargs.get("color_label", Res.trad_nada( str="color_label")),
                "description": kwargs.get("color_description", Res.trad_nada( str="color_description")),
                "emoji": kwargs.get("color_emoji", "🎨"),
                "value": "color",
            },
            {
                "label": kwargs.get("addfield_label", Res.trad_nada( str="addfield_label")),
                "description": kwargs.get("addfield_description", Res.trad_nada( str="addfield_description")),
                "emoji": kwargs.get("addfield_emoji", "➕"),
                "value": "addfield",
            },
            {
                "label": kwargs.get("removefield_label", Res.trad_nada( str="removefield_label")),
                "description": kwargs.get("removefield_description", Res.trad_nada( str="removefield_description")),
        ...
        self.children[0].placeholder = Res.trad_nada( str="edit_section_placeholder")

        self.children[1].label, self.children[1].emoji, self.children[1].style =  kwargs.get("send_label", Res.trad_nada( str="send_label")), kwargs.get("send_emoji", "✔️"), kwargs.get("send_style", ButtonStyle.gray) 
        self.children[2].label, self.children[2].emoji, self.children[2].style =  kwargs.get("cancel_label", Res.trad_nada( str="cancel_label")), kwargs.get("cancel_emoji", "✖️"), kwargs.get("cancel_style", ButtonStyle.gray) 
        self.children[3].label, self.children[3].emoji, self.children[3].style =  kwargs.get("export_label", Res.trad_nada( str="export_json_label")), kwargs.get("export_emoji", "📤"), kwargs.get("export_style", ButtonStyle.gray) 
        self.children[4].label, self.children[4].emoji, self.children[4].style =  kwargs.get("import_label", Res.trad_nada( str="import_json_label")), kwargs.get("import_emoji", "📥"), kwargs.get("import_style", ButtonStyle.gray) 
    ...
    def get_default_embed(self) -> Embed:
        ...
        title = Res.trad_nada( str='default_embed_title')
        description = Res.trad_nada( str='default_embed_description')
        author_name = Res.trad_nada( str='default_embed_author_name')
        footer_text = Res.trad_nada( str='default_embed_footer_text')
    ...
    async def export_json(self, interaction: Interaction):
        try:
            ...
            await interaction.response.send_message(content=Res.trad_nada( str="export_json_success") , file=discord.File(fp=io.BytesIO(json_str.encode("utf-8")), filename="embed.json"), ephemeral=True )

        except Exception as e:
            await interaction.response.send_message( Res.trad_nada( str="export_json_error").format(e=e), ephemeral=True )
    ...
    async def import_json(self, interaction: Interaction):
        modal = Modal( title=Res.trad_nada( str="import_json_title") )
        modal.add_item(TextInput( label=Res.trad_nada( str="import_json_modal"), style=TextStyle.paragraph, required=True ))
        ...
        async def on_submit(inter: Interaction):
            try:
                ...
                await inter.response.send_message(f"{Res.trad_nada( str='import_json_success')}", ephemeral=True )

            except Exception as e:
                await inter.response.send_message( f"{Res.trad_nada( str='import_json_error').format(e=e)}", ephemeral=True )
    ...
    async def context_exportar_embed(self, interaction: Interaction, message: discord.Message):
        try:
            if not message.embeds:
                await interaction.response.send_message( Res.trad_nada( str="export_json_no_embed"), ephemeral=True )
                return

            embed = message.embeds[0]  # pega o primeiro embed
            data = embed.to_dict()
            json_str = json.dumps(data, indent=4, ensure_ascii=False)
            await interaction.response.send_message( Res.trad_nada( str="export_json_success"), file=discord.File(fp=io.BytesIO(json_str.encode("utf-8")), filename="embed.json"), ephemeral=True )
...
class CreatorMethods:
    ...
    async def edit_author(self, interaction: Interaction) -> None:
        modal = ModalInput(title=Res.trad_nada( str="edit_author_modal_title"))
        modal.add_item( TextInput( label=Res.trad_nada( str="author_name_input_label"), max_length=100, default=self.embed.author.name, placeholder=Res.trad_nada( str="author_name_input_placeholder"), required=False, ) )
        modal.add_item( TextInput( label=Res.trad_nada( str="author_icon_url_input_label"), default=self.embed.author.icon_url, placeholder=Res.trad_nada( str="author_icon_url_input_placeholder"), required=False, ) )
        modal.add_item( TextInput( label=Res.trad_nada( str="author_url_input_label"), default=self.embed.author.url, placeholder=Res.trad_nada( str="author_url_input_placeholder"), required=False, ) )
        await interaction.response.send_modal(modal)
        await modal.wait()
        try:
    ...
    async def edit_message(self, interaction: Interaction) -> None:
        modal = ModalInput(title=Res.trad_nada( str="edit_message_modal_title"))
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="title_input_label"),
                max_length=255,
                default=self.embed.title,
                placeholder=Res.trad_nada( str="title_input_placeholder"),
                required=False,
            )
        )
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="description_input_label"),
                default=self.embed.description,
                placeholder=Res.trad_nada( str="description_input_placeholder"),
    ...
    async def edit_thumbnail(self, interaction: Interaction) -> None:
        modal = ModalInput(title=Res.trad_nada( str="edit_thumbnail_modal_title"))
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="thumbnail_url_input_label"),
                default=self.embed.thumbnail.url,
                placeholder=Res.trad_nada( str="thumbnail_url_input_placeholder"),
                required=False,
            )
        )
        await interaction.response.send_modal(modal)
    ...
    async def edit_image(self, interaction: Interaction) -> None:
        modal = ModalInput(title=Res.trad_nada( str="edit_image_modal_title"))
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="image_url_input_label"),
                default=self.embed.image.url,
                placeholder=Res.trad_nada( str="image_url_input_placeholder"),
                required=False,
            )
        )
        await interaction.response.send_modal(modal)
    ...
    async def edit_footer(self, interaction: Interaction) -> None:
        modal = ModalInput(title=Res.trad_nada( str="edit_footer_modal_title"))
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="footer_text_input_label"),
                max_length=255,
                required=False,
                default=self.embed.footer.text,
                placeholder=Res.trad_nada( str="footer_text_input_placeholder"),
            )
        )
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="footer_icon_url_input_label"),
                required=False,
                default=self.embed.footer.icon_url,
                placeholder=Res.trad_nada( str="footer_icon_url_input_placeholder"),
            )
        )
        await interaction.response.send_modal(modal)
        await modal.wait()
    ...
    async def edit_colour(self, interaction: Interaction) -> None:
        modal = ModalInput(title=Res.trad_nada( str="edit_color_modal_title"))
        modal.add_item(
            TextInput(
                label=Res.trad_nada( str="color_input_label"),
                placeholder=Res.trad_nada( str="color_input_placeholder"),
                max_length=20
            )
        )
        await interaction.response.send_modal(modal)
        ...
        try:
            ...
            await interaction.followup.send(
                Res.trad_nada( str="invalid_hex_color_error"), ephemeral=True
            )
        else:
    ...
    async def add_field(self, interaction: Interaction) -> None:
        if len(self.embed.fields) >= 25:
            return await interaction.response.send_message( Res.trad_nada( str="too_many_fields_error"), ephemeral=True )
        modal = ModalInput(title=Res.trad_nada( str="add_field_modal_title"))
        modal.add_item( TextInput( label=Res.trad_nada( str="field_name_input_label"), placeholder=Res.trad_nada( str="field_name_input_placeholder"), max_length=255, ) )
        modal.add_item( TextInput(label=Res.trad_nada( str="field_value_input_label"), max_length=2000, style=TextStyle.paragraph) )
        modal.add_item( TextInput( label=Res.trad_nada( str="inline_input_label"), default="True", max_length=5, placeholder=Res.trad_nada( str="inline_input_placeholder"), )
        )
        await interaction.response.send_modal(modal)
        await modal.wait()
        try:
            ...
            await interaction.followup.send(
                Res.trad_nada( str="invalid_boolean_error"),
                ephemeral=True,
            )
        else:
    ...
    async def remove_field(self, interaction: Interaction) -> None:
        if not self.embed.fields:
            return await interaction.response.send_message(Res.trad_nada( str="no_fields_to_remove_error"), ephemeral=True)
        field_options = list()
